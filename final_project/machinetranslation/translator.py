...
def english_to_french(english_text): # This Function Translates English To French
...
def french_to_english(french_text): # This Function Translates French To English
